...
# USAGE: ./gem5_microbench.sh <path_to_gem5_config_script> <argv[1]>
# example:
    # ./gem5_microbench.sh ./src/python/gem5/prebuilt/hifivenew/HiFiveRun.py 10
...
for bin in bins/* ; do
    ./build/RISCV/gem5.opt $1 --riscv_binary=$bin --argv=$2
